  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(600px at 50% 50%, rgba(147, 51, 234, 0.1), transparent 80%)",
        }}
      ...
      <Link
        ...
        className="block relative aspect-4/3 overflow-hidden bg-muted/20"
      >
        <img
        ...
        >
          {isInCart ? (
            ...
            <>
              ...
              <motion.div
                animate={
                  isAnimating ? { y: -20, opacity: 0 } : { y: 0, opacity: 1 }
                }
              >
                <ShoppingCart
                  size={14}
