...
export function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-lg supports-backdrop-filter:bg-background/60hadow-sm">
                  ...
                  <DropdownMenu>
                    ...
                    >
                      ...
                      <DropdownMenuItem
                        ...
                        className="rounded-lg cursor-pointer py-2.5 text-red-600 focus:text-red-600 focus:bg-red-50 dark:focus:bg-red-950/30"
                      >
                    ...
                    <div className="flex-1 overflow-y-auto py-4 px-3 custom-scrollbar">
                      <div className="space-y-1">
                        ...
                        <Link
                          href="/deals"
                          onClick={() => setIsMobileMenuOpen(false)}
                          className="flex items-center gap-3 px-3 py-3 text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/20 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                        >
