  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Xin chào! 👋 Tôi là trợ lý TechNova. Tôi có thể giúp bạn tìm kiếm linh kiện hoặc giải đáp thắc mắc kỹ thuật đấy!",
      timestamp: new Date(),
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          role: "assistant",
          content:
            "Hệ thống đang bận một chút, bạn thử lại sau giây lát nhé! 🛠️",
          timestamp: new Date(),
        },
      ]);
    } finally {
                ...
                <div className="p-4 bg-background border-t">
                        ...
                        {selectedImages.map((file, i) => (
                          <div key={i} className="relative group shrink-0">
                            ...
                            <button
                              ...
                              className="absolute -top-2 -right-2 bg-destructive text-white rounded-full p-1 shadow-lg scale-0 group-hover:scale-100 transition-transform"
                            >
                              <X size={10} />
                            </button>
                          </div>
                  ...
                  <div className="relative flex items-center bg-muted/50 rounded-3xl border border-border/50 focus-within:border-primary/50 focus-within:bg-background transition-all p-2 pr-3">
                    ...
                    <Button
                      ...
                      className="rounded-full h-10 w-10 text-muted-foreground hover:text-primary shrink-0"
                    >
                      <Camera size={20} />
                    </Button>
