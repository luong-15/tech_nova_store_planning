  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-all duration-300 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-5 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructive: 'bg-destructive text-white shadow-sm shadow-destructive/20 hover:bg-destructive/90 hover:-translate-y-0.5',
        ...
        premium: 'bg-linear-to-r from-blue-600 via-indigo-500 to-purple-500 text-white shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:opacity-90 hover:-translate-y-0.5 border-0',
        ...
        glass: 'bg-white/20 backdrop-blur-md border border-white/30 text-slate-900 shadow-sm hover:bg-white/30 dark:text-white dark:bg-slate-900/30 dark:border-slate-700/50',
      },
      size: {
