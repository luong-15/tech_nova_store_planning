      ...
      <header className="sticky top-0 z-40 w-full border-b border-border/40 bg-background/60 backdrop-blur-xl">
        <div className="container flex h-16 items-center justify-between px-4">
          <Link href="/admin" className="flex items-center gap-3 transition-opacity hover:opacity-80">
            ...
            <span className="hidden text-xl font-black tracking-tight sm:block uppercase">Admin Panel</span>
          </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <aside className={cn(
            ...
            <div className="sticky top-24 flex flex-col gap-6">
              {/* Profile Card */}
              <div className="rounded-2xl border border-border/50 bg-white dark:bg-card/50 p-4 shadow-sm backdrop-blur-md">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-sm font-bold">{user?.full_name || "Administrator"}</p>
                    <p className="truncate text-[10px] text-muted-foreground uppercase tracking-widest font-medium">{email?.split('@')[0]}</p>
                  </div>
                </div>
              </div>
                    ...
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive 
                          ...
                          : "text-muted-foreground hover:bg-white hover:text-foreground dark:hover:bg-card"
                      )}
                    >
