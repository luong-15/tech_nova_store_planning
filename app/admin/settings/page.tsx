    ...
    <div className="p-6 space-y-6 max-w-4xl">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground font-medium mt-1">Quản lý cấu hình cửa hàng và hệ thống.</p>
        </div>
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Cấu hình cơ bản hệ thống</p>
                  </div>
                </div>
              </CardHeader>
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Logo, favicon và thông tin hiển thị</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-6">
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Hiển thị trên footer và contact page</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-6">
            ...
            <Card className="border-border/50 shadow-sm">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-2xl">Bảo mật & Hiệu suất</CardTitle>
                    <p className="text-muted-foreground">Chế độ bảo trì và approve đơn hàng</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-6">
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Thuế, hiệu suất và tùy chỉnh</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-6">
