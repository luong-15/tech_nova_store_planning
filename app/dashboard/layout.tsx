              ...
              <nav className="space-y-1.5">
                ...
                <div className="pt-6 mt-6 border-t border-border/40">
                  <button
                    ...
                    className="flex w-full items-center gap-3 rounded-2xl px-4 py-3.5 text-sm font-bold text-destructive/80 transition-all hover:bg-destructive/10 hover:text-destructive group"
                  >
                    <div className="p-1 rounded-lg group-hover:bg-destructive/10 transition-colors">
