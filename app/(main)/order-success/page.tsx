          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <span
                  className={`font-medium ${order.status === "processing" ? "text-green-600" : ""}`}
                >
                ...
                <span className="font-semibold text-lg pt-1 col-span-2 border-t">
                  Tổng cộng:
                </span>
                <span className="font-semibold text-xl text-primary col-span-2">
