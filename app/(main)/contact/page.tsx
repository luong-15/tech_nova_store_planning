      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16 text-center lg:text-left max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Bạn cần tư vấn về sản phẩm hay hỗ trợ kỹ thuật? Đừng ngần ngại gửi
            tin nhắn cho đội ngũ chuyên gia của chúng tôi.
          </p>
        </div>
          ...
          <div className="lg:col-span-8 order-1 lg:order-2">
            <Card className="border-none shadow-2xl shadow-blue-500/5 bg-white/80 dark:bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] overflow-hidden">
              <CardHeader className="p-8 pb-4">
                ...
                <CardDescription>
                  Điền thông tin bên dưới, chuyên viên sẽ gọi lại cho bạn.
                </CardDescription>
              </CardHeader>
                ...
                <form className="grid gap-6">
                  <div className="grid gap-6 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="h-12 rounded-xl border-border/60 bg-background/50 focus:ring-2 focus:ring-blue-500/20"
                      />
                    </div>
                    <div className="space-y-2">
                      <label
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      rows={4}
                      className="rounded-2xl border-border/60 bg-background/50 resize-none p-4"
                    />
                  </div>
        ...
        <div className="mt-16 overflow-hidden rounded-[3rem] border border-border/50 bg-white shadow-xl">
          <div className="p-6 border-b border-border/50 flex items-center justify-between bg-slate-50/50">
            ...
            <div className="flex gap-2 text-[10px] font-bold text-muted-foreground uppercase">
              ...
              <span className="text-primary tracking-normal font-medium underline cursor-pointer">
                Chỉ đường
              </span>
            </div>
          </div>
