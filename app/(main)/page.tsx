...
import { LineReveal } from "@/components/animations/text-reveal";
import {
  StaggerContainer,
  StaggerItem,
...
export default async function HomePage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-br from-background via-primary/20 to-background py-20 md:py-32">
        ...
        <div className="container relative mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mb-6 text-balance text-4xl font-bold leading-tight text-foreground md:text-6xl">
              ...
              <span className="text-primary"> TechNova</span>
            </h1>
      ...
      {dealProducts && dealProducts.length > 0 && (
        <section className="bg-linear-to-br from-primary/5 to-background py-16">
          <div className="container mx-auto px-4">
