      ...
      <div className="container relative mx-auto px-4 py-12">
        ...
        <div className="mb-16 max-w-3xl text-center md:text-left">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed md:max-w-2xl">
            Chúng tôi cam kết mang đến dịch vụ bảo hành chính hãng, minh bạch và
            tận tâm nhất để đảm bảo quyền lợi tuyệt đối cho khách hàng.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Thời hạn 12-24 tháng theo đúng tiêu chuẩn NSX.",
              color: "text-blue-500",
              bg: "bg-blue-500/10",
            },
            {
              icon: Clock,
              title: "Hỗ trợ 24/7",
              desc: "Đội ngũ chuyên gia luôn sẵn sàng giải đáp mọi lúc.",
            ...
            },
            {
              ...
              desc: "Miễn phí cho các sản phẩm lớn tại khu vực TP.HCM.",
            ...
            },
            {
              icon: RefreshCw,
              title: "Đổi mới 100%",
              desc: "Lỗi 1 đổi 1 trong 7 ngày đầu nếu do nhà sản xuất.",
              color: "text-rose-500",
              bg: "bg-rose-500/10",
            },
          ].map((item, idx) => (
            ...
            >
              <CardContent className="p-6">
                <div
                  className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl ${item.bg} ${item.color} transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}
                >
                  <item.icon size={24} />
                </div>
              ...
              <CardContent className="p-8 pt-0 space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 group">
                    ...
                    <p className="text-sm font-medium text-slate-700 dark:text-slate-300 leading-relaxed group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                      {text}
                    </p>
                  </div>
                ))}
              ...
              <CardContent className="p-8 pt-0 space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 group">
                    ...
                    <p className="text-sm font-medium text-slate-700 dark:text-slate-300 leading-relaxed group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors">
                      {text}
                    </p>
                  </div>
                ))}
        ...
        <div className="mb-20">
          <h2 className="mb-10 text-center text-3xl font-black tracking-tighter">
            4 Bước quy trình tinh gọn
          </h2>
          <div className="grid gap-6 md:grid-cols-4 relative">
            ...
            {[
              {
                title: "Liên hệ",
                desc: "Gọi hotline hoặc gửi yêu cầu online.",
                icon: Phone,
              },
              {
                title: "Tiếp nhận",
                desc: "Kỹ thuật viên kiểm tra tình trạng máy.",
                icon: Wrench,
              },
              {
                title: "Xử lý",
                desc: "Tiến hành sửa chữa & thay thế chuẩn NSX.",
                icon: Zap,
              },
              {
                title: "Bàn giao",
                desc: "Hoàn trả thiết bị & cập nhật thời gian.",
                icon: CheckCircle,
              },
            ].map((step, idx) => (
        ...
        <div className="grid gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            {[
              {
                name: "TechNova Center TP.HCM",
                badge: "Trụ sở chính",
                address: "123 Nguyễn Huệ, Quận 1, TP.HCM",
                time: "8:00 - 18:00 (T2 - T6)",
              },
              {
                name: "TechNova Center Hà Nội",
                badge: "Chi nhánh",
                address: "456 Trần Duy Hưng, Cầu Giấy, Hà Nội",
                time: "8:00 - 17:00 (T2 - T6)",
              },
            ].map((center, idx) => (
              <Card
                key={idx}
                className="group rounded-4xl border-border/50 bg-white/50 dark:bg-slate-900/50 hover:bg-white dark:hover:bg-slate-900 transition-all hover:border-primary/30 hover:shadow-md"
              >
                <CardContent className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm font-medium flex items-center gap-2 text-muted-foreground">
                        <Clock size={14} /> {center.time}
                      </p>
                    </div>
                  </div>
                  <Button
                    variant="outline"
                    className="rounded-xl border-border/60 hover:bg-primary/5 hover:text-primary transition-colors"
                  >
                    Chỉ đường
                  </Button>
                </CardContent>
